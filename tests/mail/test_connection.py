...
from nextpy.backend.module.mail.email_utils.email_check import DefaultChecker, WhoIsXmlApi


from nextpy.backend.module.mail.mail import (
    EmailConfig,
    MailService,
    MessageSchema,
)
from nextpy.backend.module.mail.msg import MailMsg,MessageType
from nextpy.backend.module.mail.schemas import MultipartSubtypeEnum
...
async def test_attachement_message(mail_config):
    directory = os.getcwd()
    text_file = directory + "/txt_files/plain.txt"
