...
from nextpy.backend.module.mail.msg import MailMsg
from nextpy.backend.module.mail.schemas import MessageSchema, MessageType, MultipartSubtypeEnum
...
def test_plain_message_with_attachments():
    directory = os.getcwd()
    attachement = directory + "/txt_files/plain.txt"
